  ...
  return (
    <div className="lg:h-screen">
      <h1 className="lg:text-3xl text-xl lg:m-4 m-3 ">
        Fille the filds below to add a product:
      </h1>

      <form className="lg:max-w-xl max-w-xs m-auto grid gap-3">
        {/* title input */}
        <label
          className={`input input-bordered flex items-center gap-2 ${clsx(
        ...
        {/* description input */}
        <textarea
          className={`textarea textarea-bordered w-80 lg:w-full ${clsx(
